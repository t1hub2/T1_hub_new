...
local entity = spawner.Create({
	Entity = {
		Name = "Bloxy",
		Asset = "https://github.com/t1hub2/Brub/blob/main/bloxyagain.rbxm",
		HeightOffset = 0
	},
	Lights = {
		Flicker = {
	...
	Death = {
		Type = "Curious",
		Hints = {"hi", "you died to Bloxy.", "just....", "hide in a closet ok?", "Well... I'll see you later, right? You'll come back?", "Haha... of course you will."},
		Cause = ""
	}
})
